...
export async function GET() {
  ...
  let query = supabase.from('institution_onboarding').select('*')
...
export async function PUT(req) {
  ...
  let query = supabase.from('institution_onboarding').update(body).eq('id', body.id)
...
export async function DELETE(req) {
  ...
  let query = supabase.from('institution_onboarding').delete().eq('id', id)
