...
export function UsersHeader({ totalUsers, onSearchChange }: UsersHeaderProps) {
    ...
    <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
      <div className="space-y-1">
        ...
        <p className="text-sm text-slate-500">
          Managing <span className="font-medium text-slate-700">{totalUsers}</span> users across the Elimux platform.
        </p>
      </div>
